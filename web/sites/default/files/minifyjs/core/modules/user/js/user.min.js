...
password.$strengthBar[0].style.width=`${result.strength}%`;password.$strengthBar.addClass(result.indicatorClass);password.$strengthTextWrapper.html(result.indicatorText)}
if($confirmInput[0].value){passwordCheckMatch($confirmInput[0].value);$passwordConfirmMessage[0].style.visibility='visible'}else{$passwordConfirmMessage[0].style.visibility='hidden'}
