...
return `<span class="${classes.join(' ')}">${text}</a>`},tableDragCellContentWrapper(){return'<div class="tabledrag-cell-content__item"></div>'},tableDragCellItemsWrapper(){return'<div class="tabledrag-cell-content"></div>'},},)})(jQuery,Drupal)