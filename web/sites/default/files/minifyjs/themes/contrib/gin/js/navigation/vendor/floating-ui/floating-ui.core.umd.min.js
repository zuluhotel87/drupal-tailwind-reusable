...
i=-1;continue}}
return{x,y,placement:statefulPlacement,strategy,middlewareData}};function evaluate(value,param){return typeof value==='function'?value(param):value}
...
return{name:'offset',options,async fn(state){const{x,y}=state;const diffCoords=await convertValueToCoords(state,options);return{x:x+diffCoords.x,y:y+diffCoords.y,data:diffCoords}}}};function getCrossAxis(axis){return axis==='x'?'y':'x'}
